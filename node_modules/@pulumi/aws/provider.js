...
class Provider extends pulumi.ProviderResource {
    ...
    constructor(name, args, opts) {
        ...
        opts = opts || {};
        {
            ...
            inputs["profile"] = (_a = (args ? args.profile : undefined), (_a !== null && _a !== void 0 ? _a : utilities.getEnv("AWS_PROFILE")));
            inputs["region"] = (_b = (args ? args.region : undefined), (_b !== null && _b !== void 0 ? _b : utilities.getEnv("AWS_REGION", "AWS_DEFAULT_REGION")));
            ...
            inputs["skipCredentialsValidation"] = pulumi.output((_c = (args ? args.skipCredentialsValidation : undefined), (_c !== null && _c !== void 0 ? _c : true))).apply(JSON.stringify);
            inputs["skipGetEc2Platforms"] = pulumi.output((_d = (args ? args.skipGetEc2Platforms : undefined), (_d !== null && _d !== void 0 ? _d : true))).apply(JSON.stringify);
            inputs["skipMetadataApiCheck"] = pulumi.output((_e = (args ? args.skipMetadataApiCheck : undefined), (_e !== null && _e !== void 0 ? _e : true))).apply(JSON.stringify);
            inputs["skipRegionValidation"] = pulumi.output((_f = (args ? args.skipRegionValidation : undefined), (_f !== null && _f !== void 0 ? _f : true))).apply(JSON.stringify);
