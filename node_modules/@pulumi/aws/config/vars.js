 ...
 */
exports.defaultTags = __config.getObject("defaultTags");
 ...
 */
exports.skipCredentialsValidation = __config.getObject("skipCredentialsValidation") || true;
/**
 * Skip getting the supported EC2 platforms. Used by users that don't have ec2:DescribeAccountAttributes permissions.
 */
exports.skipGetEc2Platforms = __config.getObject("skipGetEc2Platforms") || true;
exports.skipMetadataApiCheck = __config.getObject("skipMetadataApiCheck") || true;
/**
 * Skip static validation of region name. Used by users of alternative AWS-like APIs or users w/ access to regions that are
 * not public (yet).
 */
exports.skipRegionValidation = __config.getObject("skipRegionValidation") || true;
/**
